...
절대 금지: 리포트 텍스트(description, scene, summary, tips 등 모든 사용자 노출 텍스트)에 z_score, raw_score, 백분위 수치, 통계 용어(z=0.46, raw 5.2 등)를 절대 포함하지 마. 점수는 내부 해석용이며 사용자에게는 자연어로만 설명해.
...
export const PARENTING_PROFILE_PROMPT_VERSION = "v1.1";
